...
Future<void> pitBackgroundMessage(RemoteMessage _) async {}

/// Firebase Messaging / APNs wrapper: token warm-up, foreground presentation,
/// message-open handling and the permission request.
class PulseHub {
  ...
  Future<void> _boot() async {
    ...
    FirebaseMessaging.onBackgroundMessage(pitBackgroundMessage);
